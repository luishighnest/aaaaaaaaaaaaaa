...
function populateCard(card, item, type, title, poster) {
    ...
    if (progress > 0) {
        ...
        if (type === 'tv' && historyItem.season && historyItem.episode) {
            badgeHtml = `<div class="vod-card-episode-badge"><i class="ph-fill ph-play-circle"></i> S${historyItem.season}:E${historyItem.episode}<span class="badge-label-resume">RIPRENDI</span></div>`;
        }
    }
